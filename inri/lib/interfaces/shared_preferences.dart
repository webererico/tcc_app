...
class Prefs {
  ...
  static Future<String> get userName async => _prefs.getString(USER_NAME_KEY) ?? '';
  ...
  static setAccessToken(String value) async => await _prefs.setString(ACCESS_TOKEN_KEY, 'Bearer ' + value);
  ...
  static setUserName(String value) async => await _prefs.setString(USER_NAME_KEY, value);
